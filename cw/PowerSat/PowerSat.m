...
%               > File > Reset all now clears the old data files and axes
%               instead of opening a new instance of PowerSat and closing
%               the old one
%               > Changed PS_Pi so that Pi is calculated faster and
%               calculated automatically if N2 and DPPH have been loaded,
%               it does not wait for all 4 datasets to be loaded.
%
...
% OLD METHOD: basically calls a new figure on top of old
...
global vars
% This creates a structure or overwrites an old one
vars.Oxy = [];
