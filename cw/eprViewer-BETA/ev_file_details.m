function varargout = ev_file_details(varargin)
...
% Last Modified by GUIDE v2.5 22-Mar-2013 13:05:51
...
% --- Executes on button press in button_add1.
function button_add1_Callback(hObject, eventdata, handles)
% hObject    handle to button_add1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_addmany.
function button_addmany_Callback(hObject, eventdata, handles)
% hObject    handle to button_addmany (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_removemany.
function button_removemany_Callback(hObject, eventdata, handles)
% hObject    handle to button_removemany (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in button_remove1.
function button_remove1_Callback(hObject, eventdata, handles)
% hObject    handle to button_remove1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
